function(build_rocksdb)
  ...
  set(THIRD_PARTY_SRC_DIR "${CMAKE_CURRENT_SOURCE_DIR/../third-party}")
  message("rocksdb dir : ${CMAKE_CURRENT_SOURCE_DIR}/../third-party/rocksdb, ${THIRD_PARTY_SRC_DIR}")
  set(rocksdb_SOURCE_DIR "${CMAKE_CURRENT_SOURCE_DIR}/../third-party/rocksdb/")
  set(rocksdb_BINARY_DIR "${CMAKE_CURRENT_SOURCE_DIR}/../third-party/rocksdb/output")
  set(rocksdb_LIBRARY "${rocksdb_BINARY_DIR}/librocksdb.so")
  message("rocksdb lib: ${rocksdb_LIBRARY}")
